...
class AddForeignKeysToMorador extends Migration
{
    ...
    public function up()
    {
        Schema::table('morador', function(Blueprint $table)
		{
            ...
            $table->foreign('id_usuario', 'fk_usuarios__morador')->references('id_usuario')->on('usuarios')->onUpdate('RESTRICT')->onDelete('RESTRICT');
    ...
    public function down()
    {
        Schema::table('morador', function(Blueprint $table)
		{
            ...
            $table->dropForeign('fk_usuarios__morador');
