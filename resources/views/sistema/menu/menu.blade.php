            ...
            <div class="list-group border-0 card bg-faded text-center text-md-left">
                ...
                <a id="a-menu" href="#" class="list-group-item" data-toggle="collapse"><i class="fas fa-map-marker"></i>  Reserva <i id="seta" class="fas fa-angle-down" style="float: right; right:0;"></i></a>
                    <div class="collapse" id="reserva">
                        <a id="a-menu" href="#" class="list-group-item">Reserva</a>
                ...
                <div class="collapse" id="morador">
                    ...
                    <a id="a-menu" href="#" class="list-group-item" data-toggle="collapse"><i class="fas fa-car"></i> Automóveis</a>
                    <a id="a-menu" href="#" class="list-group-item" data-parent="#menu3"><i class="fas fa-paw"></i> Animais</a>
                </div>
                <a id="a-menu" href="#" class="list-group-item d-inline-block collapsed" data-parent="#sidebar"><i class="fa fa-users"></i> <span class="hidden-sm-down">Funcionários</span></a>
